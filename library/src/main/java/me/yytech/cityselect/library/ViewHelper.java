...
import me.yytech.cityselect.library.animation.AnimatorProxy;

import static me.yytech.cityselect.library.animation.AnimatorProxy.wrap;

public final class ViewHelper {
    private ViewHelper() {}

    public static float getAlpha(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getAlpha() : Honeycomb.getAlpha(view);
    }
    ...
    public static float getPivotX(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getPivotX() : Honeycomb.getPivotX(view);
    }
    ...
    public static float getPivotY(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getPivotY() : Honeycomb.getPivotY(view);
    }
    ...
    public static float getRotation(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getRotation() : Honeycomb.getRotation(view);
    }
    ...
    public static float getRotationX(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getRotationX() : Honeycomb.getRotationX(view);
    }
    ...
    public static float getRotationY(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getRotationY() : Honeycomb.getRotationY(view);
    }
    ...
    public static float getScaleX(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getScaleX() : Honeycomb.getScaleX(view);
    }
    ...
    public static float getScaleY(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getScaleY() : Honeycomb.getScaleY(view);
    }
    ...
    public static float getScrollX(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getScrollX() : Honeycomb.getScrollX(view);
    }
    ...
    public static float getScrollY(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getScrollY() : Honeycomb.getScrollY(view);
    }
    ...
    public static float getTranslationX(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getTranslationX() : Honeycomb.getTranslationX(view);
    }
    ...
    public static float getTranslationY(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getTranslationY() : Honeycomb.getTranslationY(view);
    }
    ...
    public static float getX(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getX() : Honeycomb.getX(view);
    }
    ...
    public static float getY(View view) {
        return AnimatorProxy.NEEDS_PROXY ? wrap(view).getY() : Honeycomb.getY(view);
    }
